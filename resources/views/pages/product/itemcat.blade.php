                        ...
                        <div class="widget post-type-widget">
                            ...
                            <ul>
                                @foreach($other as $k => $item)
                                    <li>
                                        <figure class="post-thumbnail" style="height: 110px;">
                                            <a href="{{route('product.catproduct', ['category' => $item->category->alias, 'product' => $item->alias])}}" style="vertical-align: top;"><img src="{{empty($item->activeimg) ? asset('img/noimg.png') : $item->activeimg->img}}" alt="{{empty($item->activeimg) ? $item->name : $item->activeimg->alt}}" style="width: 100%;"></a>
                                        </figure>
                                        <h2 class="post-title">
